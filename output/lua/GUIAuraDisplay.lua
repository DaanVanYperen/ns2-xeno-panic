...
function GUIAuraDisplay:Update(deltaTime)
    ...
    for i = 1, numPlayers do
        ...
        local color = Color(1, healthScalar, 0, 1.0 - Clamp(((worldPos - eyePos):GetLength() - (kLimitedRange-3)) / 3, 0, 1))
        local distanceFraction = 1 - Clamp((worldPos - eyePos):GetLength() / 14, 0, 0.8)
