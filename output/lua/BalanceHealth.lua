...
-- XP START
-- Make hives stronger to discourage early hive assaults.
kHiveHealth = 8000    kHiveArmor = 1900    kHivePointValue = 25
kMatureHiveHealth = 8000 kMatureHiveArmor = 1900
-- XP END
...
kMatureTunnelEntranceHealth = 1250    kMatureTunnelEntranceArmor = 125
